...
const FeaturedFoods = () => {
    ...
    const firstSixItems = sortedData.slice(0, 3);

    return (
        <div className="bg-slate-50 pt-20">
            <h2 className="text-4xl text-center uppercase font-bold ml-3 mb-6">Check Our <span className="italic">Premium</span> Plates</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:mx-3 lg:mx-24 mb-10">
                {
