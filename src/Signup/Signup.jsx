...
const Signup = () => {
    ...
    return (
        <div>
            ...
            <Navbar></Navbar>
            <div className="card max-w-xl shadow-xl bg-amber-300 my-10 mx-auto rounded-sm">
                <h2 className="text-center text-3xl text-amber-700 font-bold pt-10">Register Here</h2>
                <p className="text-center">If you already have an account <Link to="/login"><span className="text-amber-700 font-semibold">Login</span></Link> here</p>
                <form onSubmit={handleRegister} className="card-body">
                    ...
                    <div className="mt-4 mx-auto">
                        <button className="btn normal-case border-none text-lg font-semibold bg-amber-600 text-white rounded-sm hover:bg-amber-500">Register</button>
                    </div>
                </form>
            </div>
            <Footer></Footer>
