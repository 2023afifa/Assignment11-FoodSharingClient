    ...
    return (
        <div>
            <div className="hero bg-gray-100">
                <div className="hero-content flex-col lg:flex-row lg:gap-6 max-w-full">
                    <img src="https://i.ibb.co/CP7PpYs/banner.jpg" className="lg:max-w-4xl rounded-lg shadow-lg" />
